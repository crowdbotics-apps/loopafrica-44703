...
export const api_v1_update_profile_pic_retrieve = createAsyncThunk(
  "userProfilePicUpdates/api_v1_update_profile_pic_retrieve",
  async payload => {
...
export const api_v1_update_profile_pic_update = createAsyncThunk(
  "userProfilePicUpdates/api_v1_update_profile_pic_update",
  async payload => {
...
export const api_v1_update_profile_pic_partial_update = createAsyncThunk(
  "userProfilePicUpdates/api_v1_update_profile_pic_partial_update",
  async payload => {
...
const userProfilePicUpdatesSlice = createSlice({
  name: "userProfilePicUpdates",
  initialState,
  reducers: {},
...
export default {
  ...
  slice: userProfilePicUpdatesSlice
}
